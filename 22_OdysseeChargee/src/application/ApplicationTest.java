...
public class ApplicationTest extends JFrame {
	...
	public ApplicationTest() {
		...
		spnPosVaisseauY.setModel(new SpinnerNumberModel(zoneAnimationPhysiqueTest.getPosVaisseauEnY(), zoneAnimationPhysiqueTest.getRayonVaisseau(),
														zoneAnimationPhysiqueTest.getHeight() - 10, 1));
		...
		spnPosVaisseauX.setModel(new SpinnerNumberModel(zoneAnimationPhysiqueTest.getPosVaisseauEnX(), zoneAnimationPhysiqueTest.getRayonVaisseau(),
														zoneAnimationPhysiqueTest.getWidth() - 10, 1));
		...
		spnLongueurPlaque.setModel(new SpinnerNumberModel(zoneAnimationPhysiqueTest.getLongueurPlaque(), 15.0, 100.0, 1.0));
		...
		spnNormalePlaqueX.setModel(new SpinnerNumberModel(zoneAnimationPhysiqueTest.getNormalePlaqueComposanteX(), -10, 10, 1.0));
		...
		spnNormalePlaqueY.setModel(new SpinnerNumberModel(zoneAnimationPhysiqueTest.getNormalePlaqueComposanteY(), -10, 10, 1.0));
