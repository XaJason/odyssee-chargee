...
/**
 * Classe qui sert de base aux classes qui vont être dérivés à partir de
 * celle-ci. Elle
 * possède toutes les propriétés et l'encapsulation que les objets interactifs
 * peuvent avoir.
 * 
 * @author Giroux
 */
...
public class Interactif {
	 ...
	 * 
	 * @param nouvValMeutrier True s'il devient meutrier, false s'il devient
	 *                        non-meutrier
	 */
	// Giroux
