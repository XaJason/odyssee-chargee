 ...
 * On specifie les rayons exterieur et interieur imaginaires sur lesquels les pointes
...
public class Etoile implements Dessinable {
    ...
    /**
     * Construire une etoile a cinq pointes, en specifiant les rayons exterieur et interieur imaginaires
     * sur lesquels les pointes seront placees.
     *
     * @param x              Le x du coin superieur-gauche du rectangle englobant l'etoile
     * @param y              Le y du coin superieur-gauche du rectangle englobant l'etoile
     * @param rayonExterieur Rayon du cercle sur lequel les pointes exterieures seront disposees
     * @param rayonInterieur Rayon du cercle sur lequel les pointes interieures seront disposees
     */
    // Caroline Houle
    ...
    /**
     * Methode privee pour creer la forme de l'etoile (un path2D)
     * Cette methode doit etre appelee de nouveau chaque fois que sa position ou dimension est modifiee
     */
    // Caroline Houle
    ...
    /**
     * Dessiner l'etoile.
     * Cette methode doit garder le contexte graphique
    ...
    public void dessiner(Graphics2D g2d) {
        ...
        if (demiEtoile) g2d.clipRect((int) x, (int) y, (int) rayonExterieur, (int) rayonExterieur * 2);
    ...
    public String toString() {
        return ("etoile: Le coin est e (" + x + ", " + y + "). Rayon exterieur = " + rayonExterieur + " et rayon interieur = " + rayonInterieur);
    }

    /**
     * Retourner la coordonnee en X du coin superieur-gauche du rectangle qui englobe l'etoile
     *
     * @return La coordonnee en X du coin superieur-gauche du rectangle qui englobe l'etoile
     */
    // Caroline Houle
    public double getX() {
        return x;
    ...
    /**
     * Modifier la coordonnee en X du coin superieur-gauche du rectangle qui englobe l'etoile
     * La geometrie sera recreee suite a ce changement.
     *
     * @param x La nouvelle coordonnee en X du coin superieur-gauche du rectangle qui englobe l'etoile
     */
    // Caroline Houle
     ...
     *
     * @return La coordonnee en Y du coin superieur-gauche du rectangle qui englobe l'etoile
     */
    // Caroline Houle
    public double getY() {
        return y;
    ...
    /**
     * Modifier la coordonnee en Y du coin superieur-gauche du rectangle qui englobe l'etoile
     * La geometrie sera recreee suite a ce changement.
     *
     * @param y La nouvelle coordonnee en Y du coin superieur-gauche du rectangle qui englobe l'etoile
     */
    // Caroline Houle
     ...
     *
     * @return Le rayon du cercle exterieur sur lequel les pointes de l'etoile sont disposees
     */
    // Caroline Houle
    ...
    /**
     * Modifier le rayon du cercle exterieur sur lequel les pointes de l'etoile sont disposees
     * La geometrie sera recree suite a ce changement.
     *
     * @param rayonExterieur Le rayon du cercle exterieur sur lequel les pointes de l'etoile sont disposees
     */
    // Caroline Houle
     ...
     *
     * @return Le rayon du cercle interieur sur lequel les pointes de l'etoile sont disposees
     */
    // Caroline Houle
    ...
    /**
     * Modifier le rayon du cercle interieur sur lequel les pointes de l'etoile sont disposees
     * La geometrie sera recree suite a ce changement.
     *
     * @param rayonInterieur Le rayon du cercle interieur sur lequel les pointes de l'etoile sont disposees
     */
    // Caroline Houle
