 ...
 * On specifie les rayons exterieur et interieur imaginaires sur lesquels les
 * pointes
...
public class Etoile implements Dessinable {
	 ...
	 * Cette methode doit etre appelee de nouveau chaque fois que sa position ou
	 * dimension est modifiee
	 */
	// Caroline Houle
