...
public class MoteurPhysique {
	...
	public static Vecteur2D detectionCollisionsAvecPlaqueEtCalculeVitesse(Vaisseau vaisseau, PlaqueChargee plaque) {
		...
		// Détermine si le vaisseau est entre les extrémités de la plaque, et donc s'il
		// est bel et bien en collision avec la plaque
		...
		try {
			...
			if (collisionExtremiteA) {
				vaisseau.setPosition(plaque.getExtremiteA()
						.additionne(normaleCollisionExtremite.multiplie(vaisseau.getRayon() + EPSILON)));
				System.out
